#!/usr/bin/env node
// Mean sRGB of rectangles in a PNG. usage: px.mjs img.png x,y,w,h[:label] ...
...
console.log(out.map(o => `${o.label.padEnd(16)} ${o.hex}  rgb(${o.r},${o.g},${o.b})  luma ${o.luma}  chroma ${o.chroma}`).join('\n'));
await browser.close();
