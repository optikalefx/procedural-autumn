...
// Viewport/dpr are now arguments: the player's window is 2560x1400 at dpr 2 and
// every measurement taken at the 1600x900 dpr1 default missed the only
// configuration that matters. Defaults unchanged.
const W=parseInt(arg('w','1600'),10), H=parseInt(arg('h','900'),10), DPR=parseFloat(arg('dpr','1'));
await acquire('perf');
