...
export const ICON = {
  ...
  // A camera on a boom, swinging round: the chase-view cycle.
  cycle: S('<circle cx="12" cy="12" r="3"/><path d="M12 3.5a8.5 8.5 0 0 1 8.5 8.5"/>' +
           '<path d="M12 20.5A8.5 8.5 0 0 1 3.5 12"/><path d="M18.4 3.9l2.3 2.3-3.2.6z"/>' +
           '<path d="M5.6 20.1l-2.3-2.3 3.2-.6z"/>'),
